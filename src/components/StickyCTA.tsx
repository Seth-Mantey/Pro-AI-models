      ...
      {isVisible && (
        ...
        >
          <a
            ...
            className="flex items-center justify-between gap-4 px-5 py-3.5 rounded-2xl bg-yellow-500 text-black shadow-[0_12px_40px_-8px_rgba(234,179,8,0.35)] active:scale-[0.97] transition-all border border-yellow-400 select-none animate-none"
          >
